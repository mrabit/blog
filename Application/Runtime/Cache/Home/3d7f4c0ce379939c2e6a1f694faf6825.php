    ...
    <div class="wrapper">
        <div class="row">
            <div class="col-xs-4 cropper-img">
                <img src="http://192.168.0.100:8080/mrabit/demo/blog/image_logo.jpg" class="img-full img-responsive">
            </div>
            <div class="col-xs-4">
...
//        });
        ...
        $(".getDataUrl").click(function () {
            $("#cropper-img").val($('.cropper-img > img').cropper("getDataURL", "image/jpeg"));
//            $(".preview").html("<img class='img-full' src='"+$("#cropper-img").val()+"'>");
        });
